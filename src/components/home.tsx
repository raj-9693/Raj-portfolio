...
const HomePage = () => {
  ...
  const HorizontalSkillBar = ({
      ...
      switch (skillName.toLowerCase()) {
            ...
            <div className={iconClass}>
              <svg width={iconSize} height={iconSize} viewBox="0 0 24 24" fill="none">
                <path
                  ...
                  fill="#FFA000" />
                <path d="M16.5 6.036l-4.5-1.5L8.5 9.036l4 14.464 8-4.5-4-13z" fill="#F57C00" />
                <path d="M12 1L8.5 9.036l3.5 14.464L16.5 6.036 12 1z" fill="#FFCA28" />
              </svg>
            </div>
          );
        case "github":
            ...
            <div className={iconClass}>
              <svg width={iconSize} height={iconSize} viewBox="0 0 24 24" fill="none">
                <path
                  ...
                  strokeWidth="2"
                  fill="#FF8A65" />
                <polyline points="7.5 4.21 12 6.81 16.5 4.21" stroke="#FF6B35" strokeWidth="2" />
                <polyline points="7.5 19.79 7.5 14.6 3 12" stroke="#FF6B35" strokeWidth="2" />
                <polyline points="21 12 16.5 14.6 16.5 19.79" stroke="#FF6B35" strokeWidth="2" />
                <polyline points="3.27 6.96 12 12.01 20.73 6.96" stroke="#FF6B35" strokeWidth="2" />
                <line x1="12" y1="22.08" x2="12" y2="12" stroke="#FF6B35" strokeWidth="2" />
              </svg>
            </div>
          );
        case "rest api":
          return (
            <div className={iconClass}>
              <svg width={iconSize} height={iconSize} viewBox="0 0 24 24" fill="none">
                <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" fill="#2196F3" />
                <path
                  d="M9 12l2 2 4-4"
                  stroke="white"
                  strokeWidth="2"
        ...
        default:
          return (
            <div className={iconClass}>
              <svg width={iconSize} height={iconSize} viewBox="0 0 24 24" fill="none">
                <rect x="2" y="2" width="20" height="20" rx="2" fill="#6366F1" />
                <polyline
                  points="16 18 22 12 16 6"
                  stroke="white"
                  strokeWidth="2"
    ...
    return (
      <div
        className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-xl p-6 cursor-pointer group border border-slate-700 hover:border-blue-500/60 shadow-lg hover:shadow-2xl hover:shadow-blue-500/20 backdrop-blur-sm relative overflow-hidden transition-all duration-300">
        ...
        <div
          className="absolute inset-0 rounded-xl bg-gradient-to-r from-blue-500/20 via-purple-500/20 to-blue-500/20 opacity-0 group-hover:opacity-100 transition-opacity duration-500 blur-sm" />
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white">
      {/* Navigation */}
      <nav
        className="container mx-auto py-6 flex justify-between items-center h-[80.9648px]">
      ...
      <section
        ...
        <div className="flex-1">
          ...
          <p className="text-gray-400 mb-8 max-w-lg">
             "I am learning Android development and building small modern apps to gain practical experience. I work with tools like Android Studio, Retrofit, Room Database, and Firebase. I always try to write clean and simple code, and I improve my skills every day by creating new projects. I enjoy learning and aim to contribute to a professional Android development team in the future."
          </p>
      ...
      <section id="resume" className="container mx-auto py-20">
        <div className="text-center mb-12">
          ...
          <div className="flex justify-center gap-4 mb-8">
            <Button
              ...
              asChild>
              <a
                href="https://drive.google.com/file/d/1-gb-CG_Pmb0bAWpxm75gqsYpyMPhC0tB/view?usp=sharing">
                <Download size={18} />
                Download Resume
              </a>
            </Button>
        ...
        <div className="max-w-4xl mx-auto">
                  ...
                  <div className="space-y-3 flex-1">
                    <div>
                      ...
                      <p
                        ...
                        using modern tools like Kotlin, Firebase,Coroutines & Flow and MVVM.
                      </p>
                    </div>
                  </div>
                </CardContent>
          ...
          <div ref={skillsRef} className="mt-8">
            <Card
              className="bg-slate-800 border-slate-700 hover:border-blue-500/50 hover:shadow-lg hover:shadow-blue-500/20 transition-all duration-300">
              <CardContent className="p-6">
                <div className="flex items-center gap-3 mb-8">
                  <div
                    className="bg-blue-500/20 w-10 h-10 rounded-lg flex items-center justify-center hover:bg-blue-500/30 transition-colors duration-300">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="24"
                      height="24"
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                  {skills.map((skill, index) => (
                    <HorizontalSkillBar key={skill.name} skill={skill} index={index} />
                  ))}
                </div>
              </CardContent>
            </Card>
